...
export function ComingSoonOverlay({ children }: { children: ReactNode }) {
	return (
		<div className="relative min-h-[24rem] overflow-hidden sm:min-h-[28rem]">
			...
			<div className="absolute inset-0 z-10 grid place-items-center bg-black/60 p-4 backdrop-blur-[2px] sm:p-6">
				<div className="admin-border-strong admin-surface w-full max-w-sm rounded-sm border px-5 py-6 text-center shadow-2xl sm:px-6 sm:py-7">
