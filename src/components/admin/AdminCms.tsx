	...
	return (
		<div className="space-y-5">
			...
			<CmsSection title="Career timeline">
				<CmsListEditor<CareerEntry> items={content.about.careerEntries} fields={[{ key: "type", label: "Type" }, { key: "start", label: "Start month", kind: "month" }, { key: "end", label: "End month", kind: "monthOrNow" }, { key: "title", label: "Title" }, { key: "place", label: "Place" }, { key: "description", label: "Description", kind: "textarea" }, { key: "lane", label: "Lane", kind: "number" }]} emptyItem={{ type: "experience", start: "", end: "Now", title: "", place: "", description: "", lane: 0 }} addLabel="Add timeline entry" onChange={(careerEntries) => updateAbout({ careerEntries })} getTitle={(item) => item.title || "Untitled entry"} />
			</CmsSection>
