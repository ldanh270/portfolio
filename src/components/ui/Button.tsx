...
const variantClasses: Record<ButtonVariant, string> = {
  primary: "bg-neutral-950 text-white shadow-[0_10px_0_#d9ff4a] hover:-translate-y-1 hover:shadow-[0_14px_0_#d9ff4a]",
  secondary: "border border-neutral-950 bg-white text-neutral-950 shadow-[0_10px_0_#111] hover:-translate-y-1 hover:shadow-[0_14px_0_#111]",
};
