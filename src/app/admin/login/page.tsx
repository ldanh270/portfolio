...
export default function AdminLoginPage() {
	return (
		<main className="admin-background admin-text grid min-h-screen place-items-center px-6">
			<div className="w-full max-w-md">
				...
				<div className="admin-border admin-surface mt-8 rounded-sm border p-6">
					<AdminLoginForm />
				</div>
			</div>
		</main>
