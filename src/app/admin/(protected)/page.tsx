		...
		<div className="space-y-8">
			<header className="flex flex-col justify-between gap-5 border-b admin-border pb-7 lg:flex-row lg:items-end">
				<div>
					...
					<h1 className="mt-3 text-[clamp(2.25rem,7vw,3.5rem)] font-semibold tracking-tight">Good to see you.</h1>
				...
				<Link href="/admin/home" className="admin-action inline-flex min-h-11 w-full items-center justify-center gap-2 px-4 py-3 text-sm font-semibold transition hover:-translate-y-0.5 sm:w-fit">Edit homepage <ArrowUpRight size={15} aria-hidden="true" /></Link>
			</header>
